...
public:
   ...
   */
  KinematicsBicycleModel(const double &wheelbase, const double &steer_lim, const double &steer_tau, double steer_gain = 1.0);
...
private:
  ...
  double steer_gain_; // calibrated command -> effective road-wheel angle
};
