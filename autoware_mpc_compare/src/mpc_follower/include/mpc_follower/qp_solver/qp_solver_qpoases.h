...
private:
  ...
  // qpOASES retains matrix storage between hotstarts; stack arrays expire.
  Eigen::Matrix<double,Eigen::Dynamic,Eigen::Dynamic,Eigen::RowMajor> h_storage_, a_storage_;
